...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.IPAddress(); !ok {
		return &ValidationError{Name: "ip_address", err: errors.New(`ent: missing required field "User.ip_address"`)}
	}
	if v, ok := uc.mutation.IPAddress(); ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.IPAddress(); ok {
